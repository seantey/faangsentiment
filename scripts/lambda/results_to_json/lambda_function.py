...
def lambda_handler(event, context):
    ...
    json_string = json_from_analysis_window(analysis_window=analysis_window)
    ...
    dynamodb.write_item(table_name='public_results_json',item_key_value_dict=item1_dict)
    dynamodb.write_item(table_name='public_results_json',item_key_value_dict=item2_dict)
